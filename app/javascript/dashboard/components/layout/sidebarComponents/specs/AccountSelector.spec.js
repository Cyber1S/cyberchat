...
import WoohModal from 'dashboard/components/Modal';
import WoohModalHeader from 'dashboard/components/ModalHeader';
import FluentIcon from 'shared/components/FluentIcon/DashboardIcon';

const localVue = createLocalVue();
localVue.component('wooh-modal', WoohModal);
localVue.component('wooh-modal-header', WoohModalHeader);
...
describe('accountSelctor', () => {
  ...
  it('title and sub title exist', () => {
    const headerComponent = accountSelector.findComponent(WoohModalHeader);
