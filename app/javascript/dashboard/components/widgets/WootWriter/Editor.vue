...
import {
  ...
  schemaWithMentions,
} from '@cyber1s/prosemirror-schema/src/mentions/schema';
...
import { wootWriterSetup } from '@cyber1s/prosemirror-schema';
...
import '@cyber1s/prosemirror-schema/src/woot-editor.css';
import {
