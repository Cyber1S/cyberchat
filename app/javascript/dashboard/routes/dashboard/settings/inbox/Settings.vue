<template>
  <div class="settings columns container">
    ...
    >
      <wooh-tabs :index="selectedTabIndex" @change="onTabChange">
        <wooh-tabs-item
          v-for="tab in tabs"
          :key="tab.key"
          :name="tab.name"
    ...
    <div v-if="selectedTabKey === 'inbox_settings'" class="settings--content">
      ...
      >
        ...
        <label v-if="isAWebWidgetInbox" class="medium-9 columns settings-item">
          ...
          <wooh-color-picker v-model="inbox.widget_color" />
        </label>
    ...
    <div v-if="selectedTabKey === 'configuration'">
      ...
      <div v-else-if="isAWebWidgetInbox">
        <div class="settings--content">
          ...
          >
            <wooh-code :script="inbox.web_widget_script"></wooh-code>
          </settings-section>
          ...
          >
            <wooh-code :script="inbox.hmac_token"></wooh-code>
          </settings-section>
          <settings-section
      ...
      <div v-else-if="isAPIInbox" class="settings--content">
        ...
        >
          <wooh-code :script="inbox.inbox_identifier"></wooh-code>
        </settings-section>
      </div>
      <div v-else-if="isAnEmailChannel">
        <div class="settings--content">
          ...
          >
            <wooh-code :script="inbox.forward_to_email"></wooh-code>
          </settings-section>
        </div>
